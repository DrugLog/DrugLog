...
public class Reminders extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reminderListView = (ListView) findViewById(R.id.list_view_reminders);
        updateReminders();
    }
    ...
    public void updateReminders(){
        ...
        for(int x = 0;x < drugManager.getReminders().size();x++){
           reminders.add(drugManager.getReminders().get(x));
        }
        ...
        reminderList = new ReminderListAdapter(this, reminders);
